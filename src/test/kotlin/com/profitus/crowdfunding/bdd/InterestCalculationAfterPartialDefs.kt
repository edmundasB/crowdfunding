...
class InterestCalculationAfterPartialDefs: InterestCalculationsDefs() {
    ...
    @When("Comes date of the payment from developer monthly payment schedule \\((\\d+)-(\\d+)-(\\d+)\\)\$")
    ...
    @Then("RE developer pays {double} EUR of interest")
